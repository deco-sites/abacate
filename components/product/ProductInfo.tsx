...
function ProductInfo({ page, layout }: Props) {
    ...
    const { productID, offers, name = '', gtin, isVariantOf, additionalProperty = [] } = product
    ...
    return (
        <div class='flex flex-col px-4' id={id}>
            ...
            <div class='mt-4 sm:mt-8'>
                <div>{gtin && <span class='text-sm text-base-300'>Cod. {gtin}</span>}</div>
                <h1>
            ...
            <div class='mt-4'>
                <div class='flex flex-row gap-2 items-center'>
                    ...
                    <span class='font-medium text-xl text-secondary'>{formatPrice(price, offers?.priceCurrency)}</span>
                </div>
            ...
            <div class='mt-4 sm:mt-10 flex flex-col gap-2'>
                {availability === 'https://schema.org/InStock' ? (
                    <>
                        {platform === 'vtex' && (
                            <>
                                <AddToCartButtonWake eventParams={{ items: [eventItem] }} productID={productID} />
                                <WishlistButtonWake
                                    variant='full'
                                    productID={productID}
                        ...
                        {platform === 'shopify' && (
                            <AddToCartButtonShopify eventParams={{ items: [eventItem] }} productID={productID} />
                        )}
                        {platform === 'nuvemshop' && (
